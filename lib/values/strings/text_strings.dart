...
const String tOnboardingSub1 = "The brand-new and reworked fordaCommute still displays different modes of transport such as Jeepneys, Buses, Vans, and now Modern Jeepneys in addition! More transport modes will be added each update in the future!";
